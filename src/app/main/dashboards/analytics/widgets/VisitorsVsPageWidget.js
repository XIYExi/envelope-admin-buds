...
function VisitorsVsPageWidget(props) {
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-42 sm:gap-48">
                    <div className="flex flex-col">
                        <div className="flex items-center">
                            ...
                            <Tooltip title="Score is calculated by using the historical ratio between Page Views and Visitors. Best score is 1000, worst score is 0.">
                                <EnvelopeSvgIcon className="ml-6" size={16} color="disabled">
                        ...
                        <div className="flex items-start mt-8">
                            ...
                            <div className="flex items-center ml-8">
                                <EnvelopeSvgIcon className="text-green-500" size={20}>
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="flex items-start mt-8">
                            ...
                            <div className="flex items-center ml-8">
                                <EnvelopeSvgIcon className="text-red-500" size={20}>
...
export default VisitorsVsPageWidget