...
function Chat(props) {
  ...
  return (
    <Paper
      className={classNames('flex flex-col relative pb-64 shadow', props.className)}
        ...
        {chat?.length === 0 && (
          <div className="flex flex-col flex-1">
            <div className="flex flex-col flex-1 items-center justify-center">
              <EnvelopeSvgIcon size={128} color="disabled">
              ...
              >
                <Paper className="rounded-24 flex items-center relative shadow">
                  ...
                  <IconButton
                    ...
                    size="large"
                  >
                    <EnvelopeSvgIcon className="rotate-90" color="action">
