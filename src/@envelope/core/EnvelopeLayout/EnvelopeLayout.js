...
function EnvelopeLayout(props) {
    const { layouts } = props;
    const dispatch = useDispatch();
    const settings = useSelector(selectEnvelopeCurrentSettings);
    const defaultSettings = useSelector(selectEnvelopeDefaultSettings);
...
export default memo(EnvelopeLayout);