import {useDebounce, usePrevious} from "../../hook";
import {
    styled,
    TextField,
    FormControl,
...
import {
    selectEnvelopeCurrentSettings,
    selectEnvelopeThemesSettings,
    setDefaultSettings
} from "../../../app/store/envelope/settingsSlice";
...
const Root = styled('div')(({ theme }) => ({
    ...
    '& .EnvelopeSettings-group': {},

    '& .EnvelopeSettings-formGroupTitle': {
        position: 'absolute',
        top: -10,
        left: 8,
        fontWeight: 600,
...
function EnvelopeSettings(props) {
    const dispatch = useDispatch();
    const user = useSelector(selectUser);
    const themes = useSelector(selectEnvelopeThemesSettings);
        ...
        (_formConfigs, prefix) =>
            Object.entries(_formConfigs).map(([key, formControl]) => {
                ...
                switch (formControl.type) {
                    case 'radio': {
                        return (
                            <Controller
                                ...
                                control={control}
                                render={({ field }) => (
                                    <FormControl component="fieldset" className="EnvelopeSettings-formControl">
                                        ...
                                        <RadioGroup
                                            ...
                                            className="EnvelopeSettings-group"
                    ...
                    case 'number': {
                        return (
                            <div key={target} className="EnvelopeSettings-formControl">
                                <Controller
                                    name={target}
                                    control={control}
                                    render={({ field }) => (
                    ...
                    case 'group': {
                        return (
                            <div key={target} className="EnvelopeSettings-formGroup">
                                <Typography className="EnvelopeSettings-formGroupTitle" color="text.secondary">
                                    {formControl.title}
                                </Typography>
    ...
    return (
        <Root>
            <div className="EnvelopeSettings-formGroup">
                <Typography className="EnvelopeSettings-formGroupTitle" color="text.secondary">
                    Layout
                </Typography>
                ...
                <Controller
                    ...
                    render={({ field }) => (
                        <FormControl component="fieldset" className="EnvelopeSettings-formControl">
                            ...
                            <RadioGroup {...field} aria-label="Layout Style" className="EnvelopeSettings-group">
            ...
            <div className="EnvelopeSettings-formGroup pb-16">
                <Typography className="EnvelopeSettings-formGroupTitle" color="text.secondary">
                    Theme
                </Typography>
            ...
            <Controller
                ...
                render={({ field }) => (
                    <FormControl component="fieldset" className="EnvelopeSettings-formControl">
                        ...
                        <RadioGroup {...field} aria-label="Layout Direction" className="EnvelopeSettings-group" row>
...
export default memo(EnvelopeSettings);
