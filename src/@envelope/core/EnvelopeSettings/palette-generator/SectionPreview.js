        ...
        >
            ...
            <div className="flex flex-col flex-auto border-l">
                <Box
                    ...
                    className={classNames('h-12 flex items-center justify-end h-full pr-6')}
                >
                ...
                <Box
                    ...
                    className={classNames('flex flex-auto border-t border-b')}
                />
                <Box
                    sx={{
                        backgroundColor:
                    ...
                    className={classNames('h-12 flex items-center pr-6')}
                >
                    <div className="w-4 h-4 ml-4 rounded-full" />
                    <div className="w-4 h-4 ml-4 rounded-full" />
                    <div className="w-4 h-4 ml-4 rounded-full" />
