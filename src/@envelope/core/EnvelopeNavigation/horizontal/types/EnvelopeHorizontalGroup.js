...
function EnvelopeNavHorizontalGroup(props) {
...
EnvelopeNavHorizontalGroup.propTypes = {
...
EnvelopeNavHorizontalGroup.defaultProps = {};

const NavHorizontalGroup = withRouter(memo(EnvelopeNavHorizontalGroup));
