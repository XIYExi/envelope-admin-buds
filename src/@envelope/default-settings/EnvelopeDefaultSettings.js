import {envelopeDark} from "../colors";
...
export function getParsedQuerySettings(){
    const parsedQuerySetting = qs.parse(window.location.search,
        {ignoreQueryPrefix: true});

    if(parsedQuerySetting && parsedQuerySetting.defaultSettings)
        return JSON.parse(parsedQuerySetting.defaultSettings);
